...
#### barchart.js
Within [this](https://github.com/tobiasmaatita/project/blob/master/scripts/barchart.js) script, the barchart is drawn upon clicking a country in the educational attainment datamap. This script contains several functions, which will be described separately.  
...
#### multipleLines.js
Within [this](https://github.com/tobiasmaatita/project/blob/master/scripts/multipleLines.js) script, the multiple linechart is drawn upon clicking a country in the educational attainment map. This script contains several functions, each of which will be described separately.
...
When comparing my [design document](https://github.com/tobiasmaatita/project/blob/master/DESIGN.md) to the final product, it seems that I have not changed an awful lot. The biggest change is that I added a fourth type of visualisation. Firstly, I changed the order in which I presented the visualisations: first opening with a linegraph instead of a worldmap.
...
For a detailed account of my day-to-day progress, please consult my [progress book](https://github.com/tobiasmaatita/project/blob/master/PROCESS.md).
